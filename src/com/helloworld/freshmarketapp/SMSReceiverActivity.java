...
public class SMSReceiverActivity extends Activity {
	...
	public void onResume() {
		...
		// Serializable, Parcelable 구현한 객체를 전송한다.
		if (bundle != null) {
	...
	OnClickListener Approval = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (et_sms.getText() != null) {
				...
				System.out.println("내부적으로 생성된 인증번호 : "
						+ SMSActivity.random.toString());
				System.out.println(et_sms.getText().toString()
						.equals(SMSActivity.random.toString()));

				if (et_sms.getText().toString()
						.equals(SMSActivity.random.toString())) {
					System.out.println("여기16");
					Intent intent = new Intent(SMSReceiverActivity.this,
							MainActivity.class);
